...
//
//    private static final String DEFAULT_NHOM_PHAN_LOAI = "AAAAAAAAAA";
//    private static final String UPDATED_NHOM_PHAN_LOAI = "BBBBBBBBBB";
//
...
//        mauPhatHanhRepository.deleteAll();
//        mauPhatHanh = createEntity();
//    }
//
//    @Test
...
//        //assertThat(testMauPhatHanh.getNhomPhanLoai()).isEqualTo(DEFAULT_NHOM_PHAN_LOAI);
...
//            .andExpect(jsonPath("$.[*].id").value(hasItem(mauPhatHanh.getId())))
//            .andExpect(jsonPath("$.[*].mauPhatHanhCode").value(hasItem(DEFAULT_MAU_PHAT_HANH_CODE.toString())))
//            .andExpect(jsonPath("$.[*].nhomPhanLoai").value(hasItem(DEFAULT_NHOM_PHAN_LOAI.toString())))
...
//            .andExpect(status().isOk())
//            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
//            .andExpect(jsonPath("$.id").value(mauPhatHanh.getId()))
//            .andExpect(jsonPath("$.mauPhatHanhCode").value(DEFAULT_MAU_PHAT_HANH_CODE.toString()))
//            .andExpect(jsonPath("$.nhomPhanLoai").value(DEFAULT_NHOM_PHAN_LOAI.toString()))
...
//            //.nhomPhanLoai(UPDATED_NHOM_PHAN_LOAI)
//            .name(UPDATED_NAME)
...
////        assertThat(testMauPhatHanh.getNhomPhanLoai()).isEqualTo(UPDATED_NHOM_PHAN_LOAI);
